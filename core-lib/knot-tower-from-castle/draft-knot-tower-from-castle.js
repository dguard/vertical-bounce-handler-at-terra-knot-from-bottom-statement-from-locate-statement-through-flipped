...
(function() {
    ...
    const Pencil = window['@pencil/draft-compact-knot-tower-from-castle']['Pencil']
    const DraftFabrikk = window['@pencil/draft-compact-knot-tower-from-castle']['DraftFabrikk']

    // keep !
    let passThroughFromBottom = {}
    passThroughFromBottom['@pencil/draft-knot-tower-from-castle'] = {}
    // keep

    passThrough['@pencil/draft-knot-tower-from-castle'] = function (spawnedPointerBelongings, passThroughKnot) {
...
passThroughFromBottom['@pencil/draft-knot-tower-from-castle']['FIELD_OF_VIEW'] = FIELD_OF_VIEW
passThroughFromBottom['@pencil/draft-knot-tower-from-castle']['PROJECTION_CENTER_Y'] = PROJECTION_CENTER_Y
passThroughFromBottom['@pencil/draft-knot-tower-from-castle']['PROJECTION_CENTER_X'] = PROJECTION_CENTER_X

passThroughFromBottom['@pencil/draft-knot-tower-from-castle']['canvas'] = ctx
...
// keep
window['@pencil/draft-knot-tower-from-castle'] = {
    passThrough: passThrough['@pencil/draft-knot-tower-from-castle'],
    passThroughFromBottom: passThroughFromBottom['@pencil/draft-knot-tower-from-castle']
}
// keep !
